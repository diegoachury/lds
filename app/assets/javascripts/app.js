...
var App = function () {
    ...
    function handleSwitcher() {    
        ...
        var setColor = function (color, data_header) {
            $('#style_color').attr("href", "assets/stylesheets/" + color + ".css");
            if(data_header == 'light'){
                $('#style_color-header-1').attr("href", "assets/stylesheets/header1-" + color + ".css");
                $('#logo-header').attr("src", "../../img/logo1-default.png");
